...
import webbrowser
from cnn_main import train_network, infer_segmentation, get_config
...
class wm_seg:
    ...
    def __init__(self, master, container):
        ...
        # model parameters
        self.param_fsl_correction = BooleanVar()
        ...
        print("Single Modality Segmentation")
        ...
        # self.flairTagLbl = Label(self.tr_frame, text="Shinkei Modality:")
        ...
        self.maskTagLbl = Label(self.tr_frame, text="Mask label:")
        self.maskTagLbl.grid(row=2, column=0,
                             sticky='E', padx=5, pady=2)
        self.maskTxt = Entry(self.tr_frame, textvariable=self.param_mask_tag)
        self.maskTxt.grid(row=2, column=1, columnspan=1, sticky="W", pady=1)
        ...
        img1 = ImageTk.PhotoImage(Image.open('./U1.jpg'))
        imglabel = Label(self.train_frame, image=img1)
        imglabel.image = img1
        imglabel.grid(row=8, column=0, padx=1, pady=1)
        ...
        # self.test_flairTagLbl = Label(self.tt_frame, text="Shinkei Modality:")
        ...
        img2 = ImageTk.PhotoImage(Image.open('./U1.jpg'))
        imglabel2 = Label(self.test_frame, image=img2)
        imglabel2.image = img2
        imglabel2.grid(row=8, column=0, padx=1, pady=1)
    ...
    def load_default_configuration(self):
        ...
        self.param_test_folder.set(default_config.get('database',
                                                      'inference_folder'))
        # self.param_FLAIR_tag.set(default_config.get('database','Shinkei_tags'))
        ...
        self.param_fsl_correction.set(default_config.get('database', 'use_of_fsl'))
    ...
    def write_user_configuration(self):
        ...
        #user_config.set('database', 'Shinkei_tags', self.param_FLAIR_tag.get())
        ...
        user_config.set('database', 'use_of_fsl', str(self.param_fsl_correction.get()))
    ...
    def about_window(self):
        ...
        img = ImageTk.PhotoImage(Image.open('./gifanim.gif'))
        ...
        l = AnimatedGIF(root, "./brain_lesion.gif")
